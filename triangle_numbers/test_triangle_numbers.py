...
class TestTriangleNumbers(unittest.TestCase):
    ...
    def test_first_triangle_number_with_2_divisor_is_3(self):
        self.assertEqual(triangle_numbers_with_divisors(2), 3)

    def test_first_triangle_number_with_3_divisor_is_6(self):
        self.assertEqual(triangle_numbers_with_divisors(3), 6)

    def test_first_triangle_number_with_4_divisor_is_6(self):
        self.assertEqual(triangle_numbers_with_divisors(4), 6)

    def test_first_triangle_number_with_5_divisor_is_28(self):
        self.assertEqual(triangle_numbers_with_divisors(5), 28)

    def test_first_triangle_number_with_6_divisor_is_28(self):
        self.assertEqual(triangle_numbers_with_divisors(6), 28)

    def test_first_triangle_number_with_500_divisor_is_76576500(self):
